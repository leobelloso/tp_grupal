...
titulo1.addEventListener('mouseenter', () => {
    ...
    titulo1.style.textShadow = "5px 5px 15px rgba(73, 217, 244, 0.5)"; 
});
...
titulo2.addEventListener('mouseenter', () => {
    ...
    titulo2.style.textShadow = "5px 5px 15px rgba(73, 217, 244, 0.5)";
});
...
titulo3.addEventListener('mouseenter', () => {
    ...
    titulo3.style.textShadow = "5px 5px 15px rgba(73, 217, 244, 0.5)";
});
